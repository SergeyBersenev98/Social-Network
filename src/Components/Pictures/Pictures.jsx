    ...
    return (   
      <form onSubmit = {props.handleSubmit} className = {classes.formForURL} >
         <div>
          ...
          <div>For example:</div>
          <div className={classes.example}>https://avatars.mds.yandex.net/get-pdb/1543238/034fccab-fe4a-4a66-aa0b-23e8791df44d/s1200?webp=false</div>
          <div className={classes.example}>https://avatars.mds.yandex.net/get-pdb/1689155/f8adfc4a-2033-421a-bde6-a65bf568e265/s1200?webp=false</div>
        </div>
        <div></div>
     </form>)
    }
